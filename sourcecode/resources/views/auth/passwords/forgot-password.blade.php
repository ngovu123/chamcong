...
@section('content')
    <div class="form-heading mb-40">
        <h1 class="title mb-8 text-capitalize">Quên mật khẩu</h1>
        <p class="subtitle mb-0 text-capitalize">Nhập email của bạn để khôi phục mật khẩu.</p>
    </div>

    <input type="hidden" id="send_reset_link_successfully" value="Gửi liên kết đặt lại thành công" />
    ...
    <p class="authenticate-now mb-0">
        <a class="link-text" href="{{ route('adminLogin') }}"> Quay lại Đăng nhập</a>
    </p>
